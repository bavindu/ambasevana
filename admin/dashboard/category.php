                    ...
                    <div>
                        <form action="" method="POST" enctype="multipart/form-data">
                            <table class="table  table-hover">
                                ...
                                <tbody>
                                    <?php
                                        include_once '../dashboard/components/categorytable.php'
                                ?>
                                </tbody>
                            </table>
                        </form>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="category_image" type="file"
                                                name="category_image" accept=".jpg,.jpeg">
                                        </div>
                                    </div>
                            </div>
                ...
                <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="../includes/updatecat.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 row">

                                        <label for="category_name" class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" placeholder="Category Name"
                                                id="categoryNameupdate" name="category_name">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="category_image" class="col-sm-2 col-form-label">Image</label>
                                    ...
                                    <div>
                                        <input type="text" id="categoryIdupdate" name="category_id" hidden>
                                    </div>
                            </div>
                            <div class="modal-footer">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary"
                                    onclick="window.location.href = '../includes/deletecat.php?delete='+document.getElementById('categoryIdDelete').value;">Delete</button></a>
