                    ...
                    <div>
                        <form action="" method="POST" enctype="multipart/form-data">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                     include_once '../dashboard/components/bookingtable.php'
                                ?>
                                </tbody>
                            </table>
                        </form>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="../includes/update.order.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 row">
                                        <div class="col-sm-3">
                                            <label for="categoryName" class=" col-form-label">Booking Status</label>
                                        </div>
                                        <div class="col-sm-9">
