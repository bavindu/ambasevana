...
$pdf->Cell(130	,5,'AMBASEWANA RESTAURANT',0,0);
$pdf->Cell(59	,5,'INVOICE',0,1);//end of line

//set font to arial, regular, 12pt
$pdf->SetFont('Arial','',12);

$pdf->Cell(130	,5,'No 23, Kumarathunga Mawatha',0,0);
$pdf->Cell(59	,5,'',0,1);//end of line

$pdf->Cell(130	,5,'Matara , Sri Lanka.',0,0);
$pdf->Cell(25	,5,'Date',0,0);
$pdf->Cell(34	,5,$date,0,1);//end of line

$pdf->Cell(130	,5,'Phone +94 71 9988 037',0,0);
...
while($item = mysqli_fetch_array($query)){
	$pdf->Cell(130	,5,$item['food_name'],1,0);
	//add thousand separator using number_format function
	$pdf->Cell(25	,5,number_format($item['order_quantity']),1,0);
	$pdf->Cell(34	,5,number_format($item['order_price']),1,1,'R');//end of line
