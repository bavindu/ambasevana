...
function component($productImg, $productName,$productPrice,$productDescription, $productId ){
    $element = "
    ...
    <form action='index2.php' method='POST'>
      <div class='card shadow' id='topic'>
        ...
        <div class='card-body' style=color:black>
          ...
          <span class='price'>$productDescription</span>
        </h6>
         
          <button type='submit' class='btn btn-success my-3' name='order' >Add to Cart</button>
...
function cartElement($productImg, $productName,$productSize, $productPrice,$productId,$productQty,$productDescription){
